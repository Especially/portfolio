...
export const ExternalLink = styled.a`
    ...
    background-image: url(${props => props.github ? props.theme.githubImg : props.theme.externalImg});
...
export const ProjectsNav = styled.div`
    ...
    justify-content: ${(props) => {
        return (props.prev && props.next) ? 'space-between' :
            (props.prev) ? 'flex-start' : 'flex-end'
    }};
    margin: 2rem 0;
`;
