    ...
    <Section>
      ...
      <div className="about__holder">
        <div className="about__content">
          ...
          <Paragraph>I think I started to actually realize my talent when it came to converting my father's way of handling his business into a much more efficient and digital way! I couldn't fathom how he managed to do everything on pen and paper, and so begun my journey (and love) of developing web applications that can make people's lives much, much easier.</Paragraph>
